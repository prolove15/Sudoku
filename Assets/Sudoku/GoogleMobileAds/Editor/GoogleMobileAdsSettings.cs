...
namespace GoogleMobileAds.Editor
{
    ...
    {
        private const string MobileAdsSettingsDir = "Assets/ColorBump/GoogleMobileAds";

        private const string MobileAdsSettingsResDir = "Assets/ColorBump/GoogleMobileAds/Resources";

        private const string MobileAdsSettingsFile =
            "Assets/ColorBump/GoogleMobileAds/Resources/GoogleMobileAdsSettings.asset";
