...
public class SellReadMeInspector : Editor
{
    public override void OnInspectorGUI()
    {
        ...
        {
            Selection.activeObject = AssetDatabase.LoadMainAssetAtPath("Assets/Sudoku/MyCombo/GameMaster.prefab");
        }
        ...
        {
            Application.OpenURL("https://docs.google.com/document/d/1r7bc26QOcJEYe3xfEurOvFhWLqsaoXVxSUf_rWppDSY/edit?usp=sharing");
        }
